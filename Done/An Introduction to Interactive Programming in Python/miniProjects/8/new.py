...
def draw(canvas):
    ...
    # draw UI
    canvas.draw_text("Lives: " + str(lives), (WIDTH * 0.10, HEIGHT * 0.05), 20, 'White', 'monospace')
    canvas.draw_text("Score: " + str(score), (WIDTH * 0.75, HEIGHT * 0.05), 20, 'White', 'monospace')
